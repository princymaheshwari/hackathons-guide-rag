---
title: "8 Types of Internal Hackathons to Drive Innovation Within Your Organization"
source_url: "https://info.devpost.com/blog/8-types-of-internal-hackathons"
source_type: "web_page"
collected_at: "2026-06-19T01:30:56Z"
...
## Why companies run internal hackathons

- Build a culture of innovation : give employees dedicated time to experiment with new ideas, technologies, and approaches outside their day-to-day work

- Accelerate product development : hackathon projects become real products more often than you might expect (at Grafana Labs, 35-40% of projects ship or make the roadmap)

- Develop AI and emerging tech skills : company hackathons are one of the most effective ways to give teams hands-on experience with new tools like generative AI

- Boost employee engagement : hackathons create opportunities for employees to showcase their skills, collaborate across departments, and feel ownership over meaningful work

- Improve cross-functional collaboration : corporate hackathons break down silos and bring engineering, product, business, and design teams together around shared goals
...
## 8 types of company hackathons at a glance
...
- AI hackathon : use artificial intelligence and machine learning to solve specific business problems

- Bug smash : identify and resolve issues in existing products or systems

- Product hack : prototype new product features or entirely novel products

- Skill-up hack : upskill and cross-skill employees through hands-on learning

- UX hack : tackle user experience problems in your app or site

- Visual design hack : push creative work forward with branding and design challenges

- OKR hackathon : accelerate quarterly goal completion through focused team competition

- Ideathon : open brainstorming to surface new ideas from across the organization
...
### Company hackathon example: Okta
...
### Company hackathon example: Grafana Labs
...
### Company hackathon example: JLL Technologies
...
## Why run an internal hackathon at your company?
...
- Shippable projects : Grafana Labs ships or roadmaps 35–40% of its hackathon projects

- Skills : JLL uses hackathons to give entire business units hands-on experience with rapidly evolving technologies like AI

- Participation growth : Okta saw a 50% increase in hackathon participants and a 7% improvement in role diversity after switching to a dedicated hackathon platform; JLL saw a 52.3% year-over-year increase
...
## How do I run an internal hackathon?
...
## Drive innovation with internal hackathons
